    ...
    return (
        ...
        >
            ...
            <div className="space-y-5 mt-16 md:mt-0">
                <h1 className="text-SpecialBlue border-SpecialBlue text-lg font-semibold">
                ...
                <p className="md:text-lg text-muted">
                    Conduct thorough candidate assessments with Loubby&apos;s
                    robust assessment platform. Customize assessments to
                    evaluate skills, knowledge, and suitability for the job.
                    Gain deeper insights into candidates’ abilities and make
                ...
                <div className="grid md:gap-3 gap-2 md:grid-cols-2">
                    {slideShow.map((item) => (
                        ...
                        >
                            <span>
                                <PiCheckBold className="text-SpecialBlue border-SpecialBlue text-2xl  font-extrabold" />
                            </span>
