    ...
    return (
        <div className="grid my-20 w-full gap-3 md:grid-cols-3 sm:grid-cols-2 grid-cols-1">
            <div className="p-6 bg-[#ECFDF3] rounded-xl space-y-4 py-8">
                ...
                <h1 className="text-2xl  font-semibold">Engaging</h1>
                <p className="text-muted">
                    Create an engaging and interactive experience for potential
                    candidates, attracting their interest in your company.
                </p>
            </div>
            <div className="p-6 bg-[#ECFDF3] rounded-xl space-y-4 py-8">
                <div className="flex">
                ...
                <h1 className="text-2xl  font-semibold">Wide Reach</h1>
                <p className="text-muted ">
                    Expand your reach to a larger pool of talent by promoting
                    your job listings and company profile across multiple
