        ...
        <div className="flex container justify-between space-y-12 flex-col md:flex-row  md:items-center">
            <div className="space-y-4">
                ...
                <h1 className="text-4xl lg:text-5xl font-bold">
                    Amplify your
                    <br className="hidden md:block" /> with powerful <br />
                ...
                <p className="text-muted/90 md:text-lg">
                    Enhance your employer brand visibility and attract{" "}
                    <br className="hidden md:block" /> top-tier talent with
                    Loubby’s powerful promotion tools.
                </p>
